/** Phase 10 — Discovery & Growth shared enums */
...
export enum FeatureFlagKey {
  ...
  ENABLE_IOT_ALERTS = 'ENABLE_IOT_ALERTS',
  ENABLE_NETWORK_INTELLIGENCE = 'ENABLE_NETWORK_INTELLIGENCE',
  ENABLE_TRUST_PROTECTION = 'ENABLE_TRUST_PROTECTION',
  ENABLE_FINANCE_BI = 'ENABLE_FINANCE_BI',
  ENABLE_LIFECYCLE_GROWTH = 'ENABLE_LIFECYCLE_GROWTH',
  ENABLE_RELIABILITY_OBSERVABILITY = 'ENABLE_RELIABILITY_OBSERVABILITY',
  ENABLE_SECURITY_COMPLIANCE = 'ENABLE_SECURITY_COMPLIANCE',
  ENABLE_SCALE_PERFORMANCE = 'ENABLE_SCALE_PERFORMANCE',
...
export enum AnalyticsEventName {
  ...
  ISSUE_RECOMMENDATION_ACCEPTED = 'ISSUE_RECOMMENDATION_ACCEPTED',
  ...
  PREDICTIVE_MAINTENANCE_VIEWED = 'PREDICTIVE_MAINTENANCE_VIEWED',
}
